...
const Index = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <button className="fixed bottom-6 right-6 bg-xstore-green text-white p-4 rounded-full shadow-lg hover:bg-xstore-dark-green transition-colors z-40 animate-pulse">
