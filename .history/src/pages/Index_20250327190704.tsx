  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <button 
        ...
        className="fixed bottom-6 left-6 bg-xstore-light-greenp text-xstore-black p-3 rounded-full shadow-lg hover:bg-xstore-light-green hover:text-white transition-colors z-40"
      >
